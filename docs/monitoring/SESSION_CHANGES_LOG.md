...
- **Root Cause**: Missing executable script - only documentation existed in `ToDoWrite/configs/commands/loadsession.md`
...
- **File**: `/Users/dderyldowney/Documents/GitHub/dderyldowney/afs_fastapi/ToDoWrite/configs/commands/fulltest.md`
...
5. **`ToDoWrite/configs/commands/fulltest.md`** - Command specification documentation
...
2. **`ToDoWrite/configs/commands/loadsession.md`** - Existing command specification (referenced)
